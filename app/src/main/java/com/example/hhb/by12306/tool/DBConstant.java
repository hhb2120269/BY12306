...
public class DBConstant {
    public static final String DATABASE_NAME = "byxx.yt46.db";
    public static final int DATABASE_VERSION = 1;

    public static final String DATABASE_TABLE = "cache";
    public static final String DATABASE_TABLE_DEFAULT = "mycache";
...
//    public static final String AGE = "age";
    ...
    public static String DUTY           = "duty";      //"工作人员",
    public static String FINGER_LIST    = "fingerList";      //[],
    public static String ID             = "id";      //0,
    public static String LIMIT          = "limit";      //0,
